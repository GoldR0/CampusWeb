...
export const studentsData: Student[] = [
  ...
  },
  {
    ...
    lastName: 'כהן',
    fullName: 'דוד כהן',
    email: 'david.cohen@student.ono.ac.il',
    phone: '052-3456789',
    address: 'רחוב הרצל 88, חיפה',
    ...
    emergencyPhone: '052-6543210',
    notes: 'סטודנט מצטיין בפיתוח'
  },
  {
    id: '10',
    ...
    lastName: 'לוי',
    fullName: 'רותי לוי',
    email: 'ruti.levi@student.ono.ac.il',
    phone: '053-4567890',
    address: 'רחוב ויצמן 12, אשדוד',
    department: 'פסיכולוגיה',
    year: 3,
    semester: 'ב',
    creditsCompleted: 92,
    ...
    enrollmentDate: '2021-10-01',
    lastActive: '2024-12-01',
    emergencyContact: 'אברהם לוי',
    emergencyPhone: '053-7654321',
    notes: 'מתמחה בטיפול קוגניטיבי'
  },
  {
    id: '11',
    ...
    lastName: 'מרגלית',
    fullName: 'אלי מרגלית',
    email: 'eli.margalit@student.ono.ac.il',
    phone: '054-5678901',
    address: 'רחוב בן גוריון 25, באר שבע',
    department: 'מתמטיקה',
    year: 1,
    semester: 'א',
    creditsCompleted: 28,
    ...
    enrollmentDate: '2023-10-01',
    lastActive: '2024-12-01',
    emergencyContact: 'מיכל מרגלית',
    emergencyPhone: '054-8765432',
    notes: 'סטודנט חדש עם פוטנציאל'
  },
  {
    id: '12',
    ...
    email: 'michal.goldberg@student.ono.ac.il',
    phone: '055-6789012',
    address: 'רחוב הרצל 33, נתניה',
    department: 'חינוך',
    year: 2,
    ...
    lastActive: '2024-12-01',
    emergencyContact: 'יוסי גולדברג',
    emergencyPhone: '055-9876543',
    notes: 'מתמחה בחינוך מיוחד'
  },
  {
    id: '13',
    ...
    lastName: 'שפירא',
    fullName: 'עמית שפירא',
    email: 'amit.shapira@student.ono.ac.il',
    phone: '056-7890123',
    address: 'רחוב ויצמן 7, תל אביב',
    department: 'כלכלה',
    year: 4,
    semester: 'ג',
    ...
    enrollmentDate: '2020-10-01',
    lastActive: '2024-12-01',
    emergencyContact: 'דינה שפירא',
    emergencyPhone: '056-8901234',
    notes: 'מתמחה בכלכלה התנהגותית'
  }
];
